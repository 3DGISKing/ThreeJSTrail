...
class THREERoot {
    constructor(params) {
        // Use ES6 destructuring with default values
        const {
        ...
        const geometry = new THREE.SphereGeometry(10, 32, 16); // Radius 1, 32 width segments, 16 height segments
        ...
        sphere.position.set(819 / 4, 0, -1000); // Position the sphere at the origin
